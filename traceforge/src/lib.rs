...
pub use new_comm_close::DimensionEnum;
pub use traceforge_macros::{DimensionEnum, Round, RoundEnum, RoundKey};
mod cons;
pub mod coverage;
...
pub struct Config {
    ...
    pub(crate) tikz_file: Option<String>,
